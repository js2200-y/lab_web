...
// application-context.xml에서 <context:component-scan>
...
public class PostService {
    ...
    // @Autowired private final PostRepository postRepository; 1. 필드에 의한 의존성 주입
...
//        return list.stream().map(PostListDto::fromEntity).toList();
    ...
    public PostDetailDto read(long id) {
        ...
        long count = replyRepository.selectReplyConutWithPostId(id);
    ...
    public int create(PostCreateDto dto) {
        ...
        // PostCreateDto 타입을 Post타입으로 변환해서
