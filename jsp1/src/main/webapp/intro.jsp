	...
	<body>
        ...
        <%--
          ...
          1. Servlet: Server + Applet 합성어.
             - 웹 서버에서 실행되는, 요청을 처리하는 작은 Java프로그램.
             - Java클래스로 작성.HttpServlet클래스를 상속.
             - 서블릿 객체의 생성과 서블릿 메서드 호출은 WAS가 담당.(tomcat)
              * 최초 요청: 서블릿 객체 생성 -> doGet, doPost 메서드 호출 -> 응답.
              * 요청: 생성되어있는 서블릿 객체의 doGet, doPost 메서드 호출 -> 응답.
              
          2. JSP: Java Server Page
             - 서블릿은 순수한 자바클래스 코드이기 때문에 HTML을 작성하기 어려움.
             - HTML 형식의 문서 안에서 자바 코드들이 실행될 수 있도록 만든 Server-side 문법.
             - JSP 실행 과정: jsp -> java -> class -> 객체 생성 -> 메서드
