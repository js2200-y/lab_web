 ...
 */
 ...
 document.addEventListener('DOMContentLoaded', function() {
    ...
    const person = {
        name: '오쌤',
        age: 16,
        phone: ['010-0000-0000', '02-0000-0000'], // 쉼표있어도 상관없음~!
        
    };
    console.log(person);
    
    // 객체의 프로퍼티 접근(사용): (1) 참조연산자 (2) 인덱스 연산자
    console.log(person.age); // person객체의 age 프로퍼티 값을 읽음.
    console.log(person['name']); // person 객체의 name 프로퍼티 값을 읽음.
    console.log(person.phone); // person객체의 age 프로퍼티 값을 읽음.
    ...
    // 객체에서 for-in  구문: 객체의 프로퍼티 이름들을 iteration.
    for (let key in person) {
     ...
     function Score(korean, english, math) {
       ...
       console.log(score2);
       console.log(score2.sum()); // 객체 메서드 호출
