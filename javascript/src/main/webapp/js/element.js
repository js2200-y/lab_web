...
// 브라우저가 HTML문서에 모든 요소들을 생성하고 난 후, 이벤트 리스너 함수를 실행.
document.addEventListener('DOMContentLoaded', function () {
    ...
    // 찾은 HTNL요소에 'cleck'이벤트 리스너를 등록!
    // addEventListener는 ('eventName', EventListener);
   ...
   btn2.addEventListener('click', function() {
    ...
    // element:peudo_selector: (예) button:hover, tr:nth-child(odd) 공백 절대안돼!!
